...
<?php 
include 'components/navbar_secondary.php';
...
<body>
  ...
  <div class="row feature-icons">
    <h3 style="color:#04AA6D;">Sign up here and select your ride</h3>
    <div class="container">
  <div class="row">
    <div class="col">
    </div>
  ...
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="assets/img/features-3.png" width="260px" height="460px">
    </div>
    <div class="col-md-8" style="background-color:#04AA6D;color:white;">
      <div class="card-body">
        ...
        <div class="g-recaptcha" data-sitekey=" "></div>     <!--recapcha-->
        <button type="submit" name="usersignup" id="usersignup" class="btn btn-primary" style="border-radius: 15px;">Register user</button>
      </form>
      </div>
    </div>
  </div>
