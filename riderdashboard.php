...
$query ="SELECT book.*,book.id as bookingid,DATE(book.datetime) as book_date, post.*,vehicle.*,rider_details.*,rider_details.code AS rider_code,rider_details.name AS driver,
            ...
            <thead>
              ...
              <tr>
                ...
                <tr>
                  ...
                  <a href="backend/rider_confirmed?completed=<?php echo $row['bookingid']?>" class="btn btn-info"style="border-radius: 20px;">Comleted</a>
                  <?php }
                  else{?>
